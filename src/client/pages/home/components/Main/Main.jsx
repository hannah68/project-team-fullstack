        ...
        <main className="homepage-main">
            ...
            <section className="top-5-pokemon-section">
                ...
                <ul className="top-pokemon-list">
                    <li>
                        <img
                            className="pokemon-rating-img"
                            src="/assets/pokemon/001.png"
                            alt="number 1 top rated"
                        />
                    </li>
                    <li>
                        <img
                    ...
                    <li>
                        <img
                            ...
                            alt="number 4 top rated"
                        />
                    </li>
                    <li>
                        <img
                            className="pokemon-rating-img"
                            src="/assets/pokemon/129.png"
                            alt="number 5 top rated"
                        />
                    </li>
                </ul>
            </section>
